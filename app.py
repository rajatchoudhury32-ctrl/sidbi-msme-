...
# ---------------- DATA ----------------
data = {
    "Year": [2010, 2015, 2020, 2021, 2022, 2023, 2024, 2025],
    "SIDBI Credit": [37969, 95000, 185000, 215000, 285000, 356000, 423000, 496282],
    "Total Assets": [52000, 135000, 255000, 300000, 352000, 402000, 522000, 568239],
    "Net Profit": [421, 950, 2300, 2500, 2850, 3343, 4027, 4811],
    "MSME Registrations": [25, 70, 120, 165, 210, 230, 480, 650],
    "Employment": [850, 1050, 1350, 1500, 1700, 1900, 2200, 2518],
    "GDP Contribution": [29.0, 28.8, 27.5, 27.3, 28.1, 29.2, 29.7, 30.0]
}
...
# ---------------- FINANCIAL TRENDS ----------------
    ...
    fig = px.bar(df, x="Year", y="Net Profit", title="Net Profit Trend")
    st.plotly_chart(chart_layout(fig), use_container_width=True)
...
# ---------------- CONCLUSION ----------------
    ...
    <div class="glass-panel">
        ...
        SIDBI financing shows a strong positive association with MSME growth across credit,
        assets, profitability, registrations, employment and GDP contribution.
        Digital formalization and institutional credit access appear to act as major
    ...
    report_text = """
    SIDBI MSME Dashboard Conclusion

    SIDBI credit schemes have shown significant growth from 2010 to 2025.
    Credit, assets, profit, MSME registrations and employment indicators improved together.
    The analysis supports the role of institutional finance in strengthening MSME development.
    """

    st.download_button(
        label="📥 Download Summary Report",
        data=report_text,
        file_name="SIDBI_MSME_Dashboard_Report.txt",
        mime="text/plain"
    )
